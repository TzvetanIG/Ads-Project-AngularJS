  ...
  this.$get = [
    ...
    function applyDirectivesToNode(directives, compileNode, templateAttrs, transcludeFn, jqCollection,
      ...
      for(var i = 0, ii = directives.length; i < ii; i++) {
        ...
        if (directive.navigationTemplate) {
          assertNoDuplicate('template', templateDirective, directive, $compileNode);
          templateDirective = directive;

          directiveValue = (isFunction(directive.navigationTemplate))
              ? directive.navigationTemplate($compileNode, templateAttrs)
              : directive.navigationTemplate;
 ...
 *
 * @element A
 * @param {navigationTemplate} ngHref any string which can contain `{{}}` markup.
 *
 * @example
 ...
 *
 * @element IMG
 * @param {navigationTemplate} ngSrc any string which can contain `{{}}` markup.
 */
 ...
 *
 * @element IMG
 * @param {navigationTemplate} ngSrcset any string which can contain `{{}}` markup.
 */
